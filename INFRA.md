...
«Продолжаем проект Express + Prisma. 
EPIC 3. Нужно: типизировать JwtPayload, расширить Express.Request (req.user)
и довести auth middleware»


➡️ Следующий шаг (логично)
...
1️⃣ Типизировать req.user
2️⃣ Описать JwtPayload (userId, sessionId)
3️⃣ Довести auth middleware до production-вида
